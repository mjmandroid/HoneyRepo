...
public class DownLoadManager {
    ...
    public DownLoadManager(AbstractCallback callBack) {
     ...
     */
    public static synchronized DownLoadManager getInstance(AbstractCallback callBack) {
        if (sInstance == null) {
    ...
    public boolean  writeResponseBodyToDisk(Context context,String taskId, ResponseBody body) {
            ...
            try {
                ...
                if (callBack != null) {
                    ...
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            callBack.onDownLoadSuccess(path, name, fileSize);
