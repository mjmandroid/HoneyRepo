...
public class HideTools {
    ...
    public static String getBankAccountFour(String src) {
        if (src == null || "".equals(src)) {
            return "";
        }
        int length = src.length();
