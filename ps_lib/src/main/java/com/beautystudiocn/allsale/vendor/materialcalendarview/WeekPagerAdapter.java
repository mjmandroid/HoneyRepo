...
public class WeekPagerAdapter extends CalendarPagerAdapter<WeekView> {
    ...
    public WeekPagerAdapter(MaterialCalendarView mcv, boolean isNeedAnimation) {
        super(mcv, isNeedAnimation);
    }

    @Override
    protected WeekView createView(int position) {
        return new WeekView(mcv, getItem(position), mcv.getFirstDayOfWeek(), mcv.getIsShowWeek(), mcv.getIsSignToday());
    }
    ...
    public static class Weekly implements DateRangeIndex {
        ...
        public CalendarDay getItem(int position) {
            ...
            calendar.setTimeInMillis(positionMillis);
