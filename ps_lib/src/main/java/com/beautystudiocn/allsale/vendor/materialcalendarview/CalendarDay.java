...
public final class CalendarDay implements Parcelable {
     ...
     * 日期状态 - 还款
     */
    public static final int STATUS_REPAYMENT = 2;
     ...
     * 日期状态 - 回款、还款
     */
    public static final int STATUS_PAY_REPAY = 4;

    /**
     * 日期状态 - 回款、结清
     */
    public static final int STATUS_PAY_SETTLE = 5;

    /**
     * 日期状态 - 还款、结清
     */
    public static final int STATUS_REPAY_SETTLE = 6;
