...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.libvpiTitlePageIndicatorStyle);
    }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LibTitlePageIndicator, defStyle, 0);

        //Retrieve the colors to be used for this view and apply them.
        mFooterLineHeight = a.getDimension(R.styleable.LibTitlePageIndicator_libfooterLineHeight, defaultFooterLineHeight);
        mFooterIndicatorStyle = IndicatorStyle.fromValue(a.getInteger(R.styleable.LibTitlePageIndicator_libfooterIndicatorStyle, defaultFooterIndicatorStyle));
        mFooterIndicatorHeight = a.getDimension(R.styleable.LibTitlePageIndicator_libfooterIndicatorHeight, defaultFooterIndicatorHeight);
        mFooterIndicatorUnderlinePadding = a.getDimension(R.styleable.LibTitlePageIndicator_libfooterIndicatorUnderlinePadding, defaultFooterIndicatorUnderlinePadding);
        mFooterPadding = a.getDimension(R.styleable.LibTitlePageIndicator_libfooterPadding, defaultFooterPadding);
        mLinePosition = LinePosition.fromValue(a.getInteger(R.styleable.LibTitlePageIndicator_liblinePosition, defaultLinePosition));
        mTopPadding = a.getDimension(R.styleable.LibTitlePageIndicator_libtopPadding, defaultTopPadding);
        mTitlePadding = a.getDimension(R.styleable.LibTitlePageIndicator_libtitlePadding, defaultTitlePadding);
        mClipPadding = a.getDimension(R.styleable.LibTitlePageIndicator_libclipPadding, defaultClipPadding);
        mColorSelected = a.getColor(R.styleable.LibTitlePageIndicator_libselectedColor, defaultSelectedColor);
        mColorText = a.getColor(R.styleable.LibTitlePageIndicator_android_textColor, defaultTextColor);
        mBoldText = a.getBoolean(R.styleable.LibTitlePageIndicator_libselectedBold, defaultSelectedBold);

        final float textSize = a.getDimension(R.styleable.LibTitlePageIndicator_android_textSize, defaultTextSize);
        final int footerColor = a.getColor(R.styleable.LibTitlePageIndicator_libfooterColor, defaultFooterColor);
        ...
        Drawable background = a.getDrawable(R.styleable.LibTitlePageIndicator_android_background);
        if (background != null) {
