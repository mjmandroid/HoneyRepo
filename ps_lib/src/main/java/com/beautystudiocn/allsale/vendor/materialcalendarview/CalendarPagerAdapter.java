...
abstract class CalendarPagerAdapter<V extends CalendarPagerView> extends PagerAdapter {
    ...
    private int selectionPadding = 0;
    ...
    CalendarPagerAdapter(MaterialCalendarView mcv, boolean isNeedAnimation) {
        this.mcv = mcv;
    ...
    public void invalidateDecorators() {
        ...
        for (DayViewDecorator decorator : decorators) {
            ...
            facade.isNeedAnimation = this.isNeedAnimation;
//            decorator.decorate(facade);
            decorator.setDecorated(facade, true);
    ...
    public CalendarPagerAdapter<?> migrateStateAndReturn(CalendarPagerAdapter<?> newAdapter) {
        ...
        newAdapter.selectionPadding = selectionPadding;
    ...
    public void setSelectionPadding(int padding) {
        ...
        for (V pagerView : currentViews) {
            pagerView.setSelectionPadding(padding);
        }
    }
    ...
    public void setDateAnimation(CalendarDay calendarDay, int resId, int taId) {
        for (V pagerView : currentViews) {
            pagerView.setDateAnimation(calendarDay, resId, taId);
        }
    }
    ...
    public void setDateAnimation(CalendarDay calendarDay, int resId, int taId, ValueAnimator animation) {
        for (V pagerView : currentViews) {
            pagerView.setDateAnimation(calendarDay, resId, taId,animation);
        }
    }
    ...
    public void setDateScale(CalendarDay calendarDay, int resId, int taId, float scaleValue) {
        for (V pagerView : currentViews) {
            pagerView.setDateScale(calendarDay, resId, taId,scaleValue);
        }
    }
