...
import com.beautystudiocn.allsale.autoupdate.product.custom.builder.IDialogBuilder;
import com.beautystudiocn.allsale.autoupdate.product.custom.builder.IDownLoader;
import com.beautystudiocn.allsale.autoupdate.product.custom.builder.IDownLoaderBuilder;
import com.beautystudiocn.allsale.autoupdate.product.custom.builder.INotificationBuilder;
import com.beautystudiocn.allsale.autoupdate.product.custom.dialog.DefaultUpdateDialog;
import com.beautystudiocn.allsale.autoupdate.product.custom.download.DefaultDownLoader;
import com.beautystudiocn.allsale.autoupdate.product.custom.download.IDownLoadListener;
import com.beautystudiocn.allsale.autoupdate.product.custom.notification.DefaultUpdateNotification;
...
import com.beautystudiocn.allsale.autoupdate.product.custom.download.IDownLoadListener;
import com.beautystudiocn.allsale.autoupdate.product.custom.notification.DefaultUpdateNotification;
import com.beautystudiocn.allsale.util.FileProvider;
...
public class CustomUpdateProduct extends AbstractAutoUpdateProduct<ICustomUpdate> implements IDownLoadListener,ICustomUpdate {
    ...
    protected ICustomUpdate build() {
        if (getUpdateVersionCode() > AppUtil.getCurrentVersionCode()|| !getUpdateVersionName().equals(AppUtil.getCurrentVersion()) ) {
