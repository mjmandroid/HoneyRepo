...
import com.beautystudiocn.allsale.mvp.network.AbstractNetworkDialog;
...
public abstract class AbstractViewDialog <T extends NetworkPresenter> extends AbstractNetworkDialog<T> implements FragmentUserVisibleController.UserVisibleCallback{
