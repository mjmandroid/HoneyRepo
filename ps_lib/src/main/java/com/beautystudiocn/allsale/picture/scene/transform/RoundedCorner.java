...
public class RoundedCorner extends BitmapTransformation {
    ...
    private static final String ID = "com.paisheng.lib.picture.scene.transform.RoundedCorner";
    ...
    public RoundedCorner(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundedCorner(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof RoundedCorner &&
                ((RoundedCorner) o).radius == radius &&
                ((RoundedCorner) o).diameter == diameter &&
                ((RoundedCorner) o).margin == margin &&
                ((RoundedCorner) o).cornerType == cornerType;
    }
