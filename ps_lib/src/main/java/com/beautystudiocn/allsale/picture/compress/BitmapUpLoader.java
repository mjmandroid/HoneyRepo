...
import com.beautystudiocn.allsale.picture.compress.compressor.DefaultBitmapCompressor;
import com.beautystudiocn.allsale.picture.compress.compressor.IBitmapCompressor;
import com.beautystudiocn.allsale.picture.compress.encode.DefaultCodeProcessor;
import com.beautystudiocn.allsale.picture.compress.encode.ICodeProcessor;
import com.beautystudiocn.allsale.picture.compress.file.DefaultUpLoadFileLocator;
import com.beautystudiocn.allsale.picture.compress.file.IUpLoadFileLocator;
import com.beautystudiocn.allsale.picture.compress.wifichecker.DefaultWifiChecker;
import com.beautystudiocn.allsale.picture.compress.wifichecker.IWifiChecker;
import com.beautystudiocn.allsale.log.LoggerManager;
import com.beautystudiocn.allsale.picture.compress.compressor.DefaultBitmapCompressor;
import com.beautystudiocn.allsale.picture.compress.compressor.IBitmapCompressor;
import com.beautystudiocn.allsale.picture.compress.encode.DefaultCodeProcessor;
...
public class BitmapUpLoader {
    ...
    public void compress(final Uri uri,
                         final IBitmapCompressCallback callback, int maxSizeInWifiNet) {
        if (maxSizeInWifiNet != 0) {
            mMaxSizeInWifiNet = maxSizeInWifiNet;
            mMaxSizeInMobileNet = maxSizeInWifiNet;
        }
        compress(uri, callback);
    }
