...
/**
 * Created by bdf on 2017/6/8.
 * <p>
 * BaseDialog shape_dialog = new BaseDialog.Builder().
 ...
 * build();
 * shape_dialog.setOnDialogClickListener(new BaseDialog.OnDialogClickListener() {
 *
 * @Override public void onOkClick() {
 * }
 * @Override public void onOk2Click() {
 * }
 * <p>
 * });
 * shape_dialog.show(getFragmentManager(), "tag");
 */
