...
public class AppMarketUtils {
    ...
    public static void gotoMarket(Context context, String packName) {
        ...
        if (keys != null) {
//          intent.setClassName(keys[0], keys[1]);vivo只能跳到首层
        ...
        if (isIntentAvailable(context, intent)) {
            ...
            ToastUtil.shortToast(context,"没有找到应用市场相关应用");
        }
    }
     ...
     * @return
     */
    public static boolean checkAliPayInstalled(Context context,String uriString) {
